								...
								while ($group_custom_settings_quantity <= 8): ?>
                                 ...
                                 <div class="tech-group">
                                     ...
                                     <dl class="list-descriptions list-unstyled">
                                         ...
                                         <div class="dd-item">
                                             <dt class="left"><?php echo esc_html($validate['custom_'. $custom_settings_quantity .'_name']); ?></dt>
                                             <dd class="right"><?php echo wp_kses_post( $PIXAD_Autos->get_meta('_custom_'. $custom_settings_quantity .'')) ?></dd>
                                         </div>
                                         <?php endif; ?>
                                         <?php	$custom_settings_quantity++ ; ?>
                                         <?php endwhile; ?>
                         ...
                         <div class="modal-dialog" role="document">
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                     ...
                                     <?php
       if (function_exists('kaswara_dashboard_menu')){
           echo do_shortcode("[kswr_cf7 cf7_id=\"$pixad_auto_form_id\" cf7_style=\"$pixad_auto_form_style\"]");

       } else {
           echo do_shortcode("[contact-form-7 id=\"$pixad_auto_form_id\" cf7_style=\"$pixad_auto_form_style\"]");
       }
       ?>
                                 </div>
