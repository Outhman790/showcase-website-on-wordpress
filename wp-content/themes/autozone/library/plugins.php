...
function autozone_register_required_plugins() {
    ...
    if($demo_type == 'elementor'){
        $plugins = array(
            ...
            array(
                'name' => esc_html__('Templines Elementor helper ', 'autozone'), // The plugin name
                'slug' => 'templines-helper-core', // The plugin slug (typically the folder name)
                'source' =>  $str_plugin_url.'&plugin='.'/elementor/templines-helper-core.zip', // The plugin source
            ...
            array(
                'name' => esc_html__( 'Youzify  ', 'autozone'), // The plugin name
                'slug' => 'youzify', // The plugin slug (typically the folder name)
                'source' => esc_url('http://assets.templines.com/plugins/youzify.zip'), // The plugin source
            ...
            array(
                'name' => esc_html__('Pix Auto Deal ( required )', 'autozone'), // The plugin name
            ...
            array(
                'name' => esc_html__('Booking auto', 'autozone'), // The plugin name
            ...
            array(
                'name' => esc_html__('elementor', 'autozone'), // The plugin name
            ...
            array(
                'name' => esc_html__('bbPress ', 'autozone'), // The plugin name
            ...
            array(
                'name' => esc_html__('BuddyPress ', 'autozone'), // The plugin name
