              ...
              <div class='pix_about_block'>
                  <div class='pix_about_block_inner'>
                      <h2 class='pix_about_block_title'>
                          ...
                          " . esc_html__("Theme documentation", "autozone") . "
                      </h2>
                      <div class='pix_about_block_description'>
          ...
          if ( !TGM_Plugin_Activation::get_instance()->is_tgmpa_complete() ) {
              echo wp_kses_post("<div class='pix_about_block'>
                  <div class='pix_about_block_inner'>
                      ...
                      <div class='pix_about_block_description'>
                          " . esc_html__("Theme autozone is compatible with a large number of popular plugins. You can install only those that are going to use in the near future. Please select  page builder you want to use and install plugins.", "autozone") . "
                      </div>
                    <a href='" . esc_url(admin_url('themes.php?page=tgmpa-install-plugins&demo_type=elementor')) . "' class='pix_about_block_link button button-primary'>" . esc_html__("I want Elementor", "autozone") . "</a>
                    <a href='" . esc_url(admin_url('themes.php?page=tgmpa-install-plugins&demo_type=vc')) . "' class='pix_about_block_link button button-primary'>" . esc_html__("I want WPBakery", "autozone") . "</a>
                  </div>
              </div>");            
          }
              echo wp_kses_post("<div class='pix_about_block'>
                  <div class='pix_about_block_inner'>
                      ...
                      <div class='pix_about_block_description'>
                          " . esc_html__("Importing demo data (post, pages, images, theme settings, ...) is the easiest way to setup your theme.  It will allow you to quickly edit everything instead of creating content from scratch. Please before install Required plugins", "autozone") . "
                      </div>
