	...
	">
        ...
        <div class="side-logo">
            <a class="navbar-brand" href="<?php echo esc_url(home_url('/')) ?>">
                ...
                <img class="scroll-logo" src="<?php echo esc_url($autozone_header['logo_inverse']) ?>" alt="logo" />
                <?php else: ?>
                <img class="scroll-logo" src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="logo" />
                <?php endif ?>
                <?php endif; ?>
            </a>
        </div>
        ...
        <div class="side-cart">
            <div class="header-cart">
                <a href="<?php echo WC()->cart->get_cart_url(); ?>"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
